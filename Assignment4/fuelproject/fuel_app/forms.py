...
class QuoteForm(forms.Form):
    gallons = forms.IntegerField(label='', min_value=0, required=True,
    ...
    address = forms.CharField(max_length=95, label='', required=True,
    ...
    total_price = forms.FloatField(label='',
        widget=forms.NumberInput(attrs={'class': 'form-control col-2 mx-auto', 'readonly': 'readonly'}))
...
class ProfileForm(forms.Form):
    ...
    address_1 = forms.CharField(label="Address 1*", max_length=200, required=True,
        widget=forms.TextInput(attrs={'class': 'form-control'}))
    address_2 = forms.CharField(label="Address 2*", max_length=200, required=True,
        widget=forms.TextInput(attrs={'class': 'form-control'}))    
