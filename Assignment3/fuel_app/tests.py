...
class QuoteFormTests(TestCase):
    ...
    def test_add_user_invalidform_view(self):
        response = self.client.post("/", {'gallons': "zerosssormore", 'address': "dds", 'date': "random", 'dsjf': "dfdfsdf"})
        self.assertEqual(response.status_code, 200)
    ...
    def test_add_admin_form_view(self):
        ...
        response = self.client.post("/", {'gallons': "zerosssormore", 'address': "", 'date': ""})
        self.assertEqual(response.status_code, 200)
...
class ProfileTests(TestCase):
    ...
    def test_profile_form_is_valid(self):
         response = self.client.post(
             "/", data={'full_name': 'first middle last',
